...
export default function Layout(){
    ...
    return (
        <div className="h-full flex flex-col bg-paper transition-colors overflow-hidden">
            ...
            */}
            <main className="flex-1 overflow-y-auto overflow-x-hidden overscroll-contain pt-[calc(5rem+env(safe-area-inset-top))] pb-[calc(8rem+env(safe-area-inset-bottom))] px-4 w-full max-w-lg mx-auto">
                <Outlet />
            </main>
